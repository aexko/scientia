...
public class Adaptateur extends RecyclerView.Adapter<Adaptateur.RecyclerViewHolder> {
    ...
    public Adaptateur(Context context, ArrayList<String> imagePathArrayList) {
        ...
        if (imgFile.exists()) {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent i = new Intent(context, ImageDetailleeActivity.class);
