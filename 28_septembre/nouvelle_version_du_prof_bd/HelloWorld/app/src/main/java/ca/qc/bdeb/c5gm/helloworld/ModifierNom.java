...
public class ModifierNom extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Joueur j = message.getParcelableExtra("JOUEUR1");
    ...
    public void onClickOK(View view) {
        ...
        resultat.putExtra(MainActivity.NOM_J_1, etNomJ1.getEditableText());
        resultat.putExtra(MainActivity.NOM_J_2, etNomJ2.getEditableText());
